...
public class ParaHeadNumber {
    ...
    public static String toString(int value, NumberType1 format) {
        if (value <= 0) {
            return "";
        }
    ...
    public static String toString(int value, NumberType2 format) {
        if (value <= 0) {
            return "";
        }
