...
public class SimplePolygon {
    ...
    public void test() throws Exception {
        ...
        Assert.assertEquals(renderingInfo.transMatrix().e3().floatValue(), 2218);
        ...
        Assert.assertEquals(renderingInfo.transMatrix().e6().floatValue(), 4191);
        Assert.assertEquals(renderingInfo.scaMatrix().e1().floatValue(), 1.000037f);
        Assert.assertEquals(renderingInfo.scaMatrix().e2().floatValue(), -0.000023f);
        Assert.assertEquals(renderingInfo.scaMatrix().e3().floatValue(), -0);
        Assert.assertEquals(renderingInfo.scaMatrix().e4().floatValue(), -0.000023f);
        Assert.assertEquals(renderingInfo.scaMatrix().e5().floatValue(), 0.999973f);
        Assert.assertEquals(renderingInfo.scaMatrix().e6().floatValue(), -0);
        Assert.assertEquals(renderingInfo.rotMatrix().e1().floatValue(), 0.766044f);
        Assert.assertEquals(renderingInfo.rotMatrix().e2().floatValue(), -0.642788f);
        Assert.assertEquals(renderingInfo.rotMatrix().e3().floatValue(), 6411.34082f);
        Assert.assertEquals(renderingInfo.rotMatrix().e4().floatValue(), 0.642788f);
        Assert.assertEquals(renderingInfo.rotMatrix().e5().floatValue(), 0.766044f);
        Assert.assertEquals(renderingInfo.rotMatrix().e6().floatValue(), -4190.996094f);
