...
2026.08.31
=========================================================================================
* 이슈33: 하이픈 컨트롤을 저장하는 테그명이 <hp:hyphen> ==> <hp:hypen> 으로 변경.. 스팩의 영문 오류인 것 같음.

2026.08.12
=========================================================================================
* 이슈32: <hp:t> 태그 안에 <hp:unknownchar>가 포함된 파일을 읽을 때 오류나는 문제 해결

2026.08.06
=========================================================================================
* 이슈31: <hp:run> 태그 안에 <hp:markpenEnd>가 포함된 파일을 읽을 때 오류나는 문제 해결

2026.08.05
=========================================================================================
* 이슈30: 고정폭 빈칸 객체(FWSpace)의 clone() 오류 수정


2026.07.14
=========================================================================================
* 이슈27: NumberType1 에 "갑,을,병" type 추가..
* 이슈28: SwitchableObject을 상속받은 클래스의 copyFrom()에 super.copyFrom() 호출 누락 수정..
* section.xml에 SubList 엘리멘트에 metaTag의 인코딩 오류 수정
